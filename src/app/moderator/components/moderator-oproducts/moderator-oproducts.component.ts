...
@Component({
  selector: 'app-moderator-oproducts',
  imports: [CommonModule, ReactiveFormsModule, HttpClientModule, ModeratorHeaderComponent, SidebarModeratorComponent],
  templateUrl: './moderator-oproducts.component.html',
  styleUrl: './moderator-oproducts.component.css'
})
export class ModeratorOproductsComponent implements OnInit {
